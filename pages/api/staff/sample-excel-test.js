...
export default async function handler(req, res) {
  ...
  try {
    ...
    const csvData = [
      ...
      'John,Doe,William,john.doe@company.com,+919876543210,john.doe,Software Engineer,Engineering,branch_staff,,1990-01-15,Male,123 Main Street,Mumbai,Maharashtra,400001,Jane Doe,+919876543211,50000,2024-01-01,,123456789012,ABCDE1234F,en,true',
    ...
    return res.status(500).json({ 
      success: false, 
      error: 'Failed to generate sample file: ' + error.message 
    });
  }
}